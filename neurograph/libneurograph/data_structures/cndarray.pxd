...
cdef extern from "<data_structures/ndarray/includes/ops.h>":

   NDArray *ndot(NDArray *a, NDArray *b)
   NDArray *nadd(NDArray *t, NDArray *val)
   NDArray *nsubtract(NDArray *t1, NDArray *t2)
   NDArray *nscale_add(NDArray *a, NDArray *b)
   NDArray *ntranspose(NDArray *t)
   NDArray *permute(NDArray *t, int *indice_order)